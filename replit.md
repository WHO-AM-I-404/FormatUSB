...
- **25 Sep 2025**: Updated copyright ke FormatUSB Team (bukan MX Linux)
...
- **25 Sep 2025**: Updated version ke 25.1.0 dengan branding yang konsisten

## User Preferences
- **Copyright**: Harus menggunakan "FormatUSB Team" bukan MX Linux
- **GUI Style**: Kompak dan solid dengan modern styling
- **Version**: Konsisten menggunakan v25.1.0 di semua file
...
├── version.h         # Version definitions (25.1.0)
